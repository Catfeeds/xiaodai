...
class String {
    ...
    # 生成推广码
    static public function generate_promotion_codes($no_of_codes,$exclude_codes_array='',$code_length = 4){
    ...
    static public function endWith($haystack, $needle) {   
     ...
     # 包含
     static public function contains($str,$needle){

        if(!$str){
            return false;
        }

        if(($s=stripos($str, $needle)) !== false){
            return true;
        }else{
            return false;
        }
     ...
     static public function checkLang($string){
