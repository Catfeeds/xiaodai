...
/*	/*	/*	/*
			...
			*/
			.foot p {margin: 10px 0;width: 300px;font-size: 12px;
			}
	...
	<script type="text/javascript" src="/Public/newcss1/js/jquery-1.9.1.js"></script>
	<body id="html">
		<div class="center" style="max-width: 800px;margin: 0 auto;box-sizing: border-box;padding: 20px;">
			...
			<div class="text" style="line-height: 1.5;font-size: 14px;">
				协议编号:<?php echo ($loan['bianhao']); ?>
				甲方(出借人):王海雨 (已认证) 甲方身份证号:    甲方手机号:13518143416 甲方 乙方(借款人):<?php echo ($member['username']); ?> (已认证)
				乙方身份证号:<?php echo ($member['idcard']); ?> 乙方手机号:<?php echo ($member['telephone']); ?>  甲乙双方因借款事宜，经协商达成如下协议:
			...
			<div class="text" style="line-height: 1.5;font-size: 14px;">
				借款金额:<?php echo ($loan['damount']); ?>元 借款日期:<?php echo ($loan['addtime']); ?> 还款日期:<?php echo ($loan['deadline']); ?> 年化利率:0.24 借款用途:其他 本息共计<?php echo ($loan['amount']); ?>:元 还款方式:到期还本付息
			...
			<div class="foot" style="overflow: hidden;margin-top: 20px;float: right;">
				...
				<p style="margin: 10px 0;width: 300px;font-size: 12px;">乙方(借款人):<?php echo ($member['username']); ?></p>
				<p style="margin: 10px 0;width: 300px;font-size: 12px;">丙方(居间服务商): U易网络技术有限公司</p>
				<p style="margin: 10px 0;width: 300px;font-size: 12px;">签订日期:<?php echo ($time); ?></p>
			</div>
		</div>
...
<script>
	alert("请点击页面保存为pdf文件");
	$("body").click(function () {
		//var html=encodeURI($("#html").html());
		//alert(html);
		window.location.href="/Admin/Member/getpdf/str/<?php echo ($loan['orderno']); ?>.html";
