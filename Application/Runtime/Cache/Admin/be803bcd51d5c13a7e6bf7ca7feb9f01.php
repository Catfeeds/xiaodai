...
<div class="row">
    <div class="col-md-12">
      ...
      <table class="table vm">
        ...
        <tbody> 
          <tr>
            <td  class="text-right" width="140"><?php echo ($name); ?>状态：</td>
            <td><div class="col-md-12">
            <a href="<?php echo set_url('status','');?>" ><span class="label label-default">全部</span></a>
      ...
      <table class="table  table-first-column-number display full table-striped custom-table vm">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <tr>
            <td colspan="6"><?php if(!empty($page)): ?><div class="pull-left custom-footer">
