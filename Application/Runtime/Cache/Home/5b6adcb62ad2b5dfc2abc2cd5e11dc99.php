...
<script src="/Public/newcss1/js/myfunc-1.0.0.js" type="text/javascript" charset="utf-8"></script>
	...
	<body style="background: #f5f5f5;">
		...
		<div style="padding: 0.12rem;margin: 0.12rem;overflow: hidden;font-size: 0.14rem;">
			<a style="text-decoration: underline;color: #E6BC85;float: left;" href="<?php echo U('login/forget');?>">忘记密码？</a>
			<a style="text-decoration: underline;color: #E6BC85;float: right;" href="<?php echo U('login/register');?>">注册账号</a>
		</div>
		<label style="text-align: center;position: absolute;bottom: 0.8rem;left: 0.24rem;color: #999;font-size: 0.12rem;">
			...
			<span style="vertical-align: middle;">同意<a href="<?php echo U('Login/contract');?>">《用户协议》</a></span>
		</label>
		<style type="text/css">
			.bot-btn {
